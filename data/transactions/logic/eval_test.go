...
&&`)
	...
	txn.Txn.VoteKeyDilution = 1
	txgroup[0].SignedTxn = txn
	txgroup[1].SignedTxn.Txn.Amount.Raw = 42
	txgroup[1].SignedTxn.Txn.Fee.Raw = 1066
	txgroup[1].SignedTxn.Txn.FirstValid = 42
	txgroup[1].SignedTxn.Txn.LastValid = 1066
	txgroup[1].SignedTxn.Txn.Sender = txn.Txn.Receiver
	txgroup[1].SignedTxn.Txn.Receiver = txn.Txn.Sender
	txn.Lsig.Logic = program
	txn.Lsig.Args = [][]byte{
		txn.Txn.Sender[:],
		txn.Txn.Receiver[:],
