...
func TestMarshalUnmarshalAppData(t *testing.T) {
	v := AppData{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func TestRandomizedEncodingAppData(t *testing.T) {
	protocol.RunEncodingTest(t, &AppData{})
}

func BenchmarkMarshalMsgAppData(b *testing.B) {
	v := AppData{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgAppData(b *testing.B) {
	v := AppData{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalAppData(b *testing.B) {
	v := AppData{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestMarshalUnmarshalTotalAppInfo(t *testing.T) {
	v := TotalAppInfo{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func TestRandomizedEncodingTotalAppInfo(t *testing.T) {
	protocol.RunEncodingTest(t, &TotalAppInfo{})
}

func BenchmarkMarshalMsgTotalAppInfo(b *testing.B) {
	v := TotalAppInfo{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgTotalAppInfo(b *testing.B) {
	v := TotalAppInfo{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalTotalAppInfo(b *testing.B) {
	v := TotalAppInfo{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
